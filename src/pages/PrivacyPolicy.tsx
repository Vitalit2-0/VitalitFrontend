...
function PrivacyPolicy() {
    return (
        <div className="py-36 px-10 md:px-20">
            <h1>Política de Privacidad</h1>
            <p>Fecha última actualización: 14 de Febrero del 2024</p>

            <h2 className="mt-10 font-bold">1. Introducción</h2>
            <p>En Vitalit, nos comprometemos a proteger la privacidad y seguridad de nuestros usuarios. Esta política de privacidad explica cómo recopilamos, utilizamos, divulgamos y protegemos la información personal que obtenemos a través de nuestra plataforma.</p>

            <h2 className="font-bold mt-5">2. Información que Recopilamos</h2>
            <p>Recopilamos varios tipos de información de nuestros usuarios, incluyendo:</p>
            <ul>
            ...
            <h2 className="font-bold mt-5">4. Divulgación de la Información</h2>
            ...
            <ul>
                ...
                <li>Para proteger los derechos, propiedad o seguridad de Vitalit, nuestros usuarios u otros.</li>
            </ul>

            <h2 className="font-bold mt-5">5. Seguridad de la Información</h2>
            ...
            <footer>
                <p>&copy; 2024 Vitalit. Todos los derechos reservados.</p>
            </footer>
        </div>
    )
}
