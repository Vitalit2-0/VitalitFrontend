...
function HamburguerMenu({ onClick, open } : { onClick: any, open?: boolean }) {
    ...
    return (
        <div className={`absolute right-10 md:right-20 overflow-hidden w-16 h-16 lg:hidden`}>
            <div id='burguer-menu' className={`plate plate2 absolute top-[-2px] left-[-5px] ${open ? "active" : ""}`} onClick={handleToggleMenu}>
